...
/**
 * GUI-specific Gemini adapter.
 *
 * The original AIClient is intentionally not modified. This keeps the
 * original console implementation working exactly as it did before the GUI.
 */
public class GUIAIClient {
